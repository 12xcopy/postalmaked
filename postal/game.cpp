...
//note: this is kind of too soon dog. should probably be removed.
//the dudes who pirated postal betas in 97 will be so happy to finally play the game
...
static int16_t LoadAssets(void)
	...
	//titles are done now, so change gamemode
	pgamemode_set(POSTAL_GAMEMODE_MenuLogo);
	return 0;
	}
