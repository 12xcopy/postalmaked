...
#ifdef PMAKED_JUST_COMPILE

#warning BLiTSprite.cpp tried to be included. using wildcards?

#else

//come on man.. you should use a #warning and an #if 0 for this
...
*/
	...
	//note: this label is commented out in real postal
	BLIT_PRELOCKED:
